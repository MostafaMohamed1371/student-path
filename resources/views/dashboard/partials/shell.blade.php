<div class="dashboard-shell">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('dashboard.assigned_drivers.index') }}" class="sidebar-link {{ request()->routeIs('dashboard.assigned_drivers.*') ? 'is-active' : '' }}">{{ __('dashboard.menu_assigned_driver_in_route') }}</a>
            ...
            <a href="{{ route('dashboard.notifications.hub') }}" class="sidebar-link {{ request()->routeIs('dashboard.notifications.hub', 'dashboard.in_app_notifications*', 'dashboard.fcm_tokens*', 'dashboard.delay_alerts', 'dashboard.sos_alerts', 'dashboard.trip_finalization_reports') ? 'is-active' : '' }}">{{ __('dashboard.menu_notifications_hub') }}</a>
            ...
            <a href="{{ route('dashboard.fcm_tokens.index') }}" class="sidebar-link {{ request()->routeIs('dashboard.fcm_tokens.*') ? 'is-active' : '' }}" style="padding-left: 1.25rem; font-size: 0.92rem;">{{ __('dashboard.menu_fcm_tokens') }}</a>
