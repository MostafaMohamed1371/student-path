...
class DashboardTripLocationFilterTest extends TestCase
{
    use RefreshDatabase;

    public function test_trips_index_can_be_filtered_by_iraq_location(): void
    {
        ...
        TripHistory::query()->create([
            'school_id' => $school->id,
            'driver_id' => $karradaDriver->id,
            'trip_type' => 'MORNING_PICKUP',
            'bus_number' => 'BUS-KARRADA',
            'route_title' => 'Karrada Route',
            'start_time' => now(),
            'status' => 'PRESENT',
        ]);
        TripHistory::query()->create([
            ...
            'bus_number' => 'BUS-KARKH',
            'route_title' => 'Karkh Route',
            'start_time' => now(),
            'status' => 'PRESENT',
        ]);
        ...
        $this->get(route('dashboard.trips.index'))
            ->assertOk()
        ...
        $this->get(route('dashboard.trips.index', [
            ...
            ->assertOk()
            ->assertSee('BUS-KARRADA', false)
            ->assertSee('Karrada Route', false)
            ->assertDontSee('BUS-KARKH', false)
            ->assertDontSee('Karkh Route', false);
    }
}
