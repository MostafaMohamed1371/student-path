...
class DashboardIdCardUniquenessTest extends TestCase
{
    ...
    public function test_guardian_cannot_reuse_driver_id_card_number(): void
    {
        ...
        $response = $this->post(route('dashboard.guardians.store'), $this->withGuardianHomeIraqLocation([
            'school_id' => $school->id,
    ...
    public function test_same_guardian_id_card_allowed_at_different_schools(): void
    {
        ...
        $this->post(route('dashboard.guardians.store'), $this->withGuardianHomeIraqLocation([
    ...
    public function test_student_lookup_guardian_by_id_card(): void
    {
        ...
        $expectedDistrictArea = app(\App\Services\Locations\IraqLocationAttributeResolver::class)->label(
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('guardian.home_district_area', $expectedDistrictArea)
    ...
    public function test_student_store_rejects_two_word_full_name_before_parent_append(): void
    {
        ...
        $this->post(route('dashboard.students.store'), $this->withStudentIraqLocation([
            'school_id' => $school->id,
    ...
    public function test_student_create_does_not_convert_guardian_user_to_student(): void
    {
        ...
        $response = $this->post(route('dashboard.students.store'), $this->withStudentIraqLocation([
            'school_id' => $school->id,
