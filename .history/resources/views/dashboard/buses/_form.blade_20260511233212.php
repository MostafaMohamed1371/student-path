...
<div class="form-grid">
    ...
    <div style="grid-column: 1 / -1;">
        <label class="field-label" for="route_description">{{ __('dashboard.bus_route_description') }}</label>
        <textarea class="input" id="route_description" name="route_description" rows="2" placeholder="{{ __('dashboard.bus_route_description_placeholder') }}">{{ old('route_description', $bus?->route_description) }}</textarea>
    </div>
