...
class DashboardGuardianController extends Controller
{
    ...
    public function edit(Guardian $guardian): View
    {
        ...
        return view('dashboard.guardians.edit', [
            ...
            ...$this->iraqLocationFormContext(
                (int) old('district_id', $homeLocation?->district_id ?? 0),
                (int) old('area_id', $homeLocation?->area_id ?? 0),
                old('neighborhood_ids', $homeLocation?->neighborhoods->pluck('id')->all() ?? []),
            ),
        ]);
    }
    ...
    private function syncGuardianHomeLocation(
        ...
        $attributes = $locationPayload['attributes'];
        ...
        $homeLocationSync->syncForUser(
            ...
            isset($attributes['district_id']) ? (int) $attributes['district_id'] : null,
            isset($attributes['area_id']) ? (int) $attributes['area_id'] : null,
            $locationPayload['neighborhood_ids'],
        );
    }
}
